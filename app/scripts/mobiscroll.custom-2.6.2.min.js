...
p.theme]);Aa=wa.i18n[a.lang||p.lang];i(c,a);i(p,ka.defaults,Aa,c);n.settings=p;G.off(".dw");if(a=wa.presets[p.preset])qa=a.call(N,n),i(p,qa,c);na=Math.floor(p.rows/2);H=p.height;T=p.animate;W&&n.hide();if("inline"==p.display)n.show();else{l();if(aa&&(void 0===ua&&(ua=N.readOnly),N.readOnly=!0,p.showOnFocus))G.on("focus.dw",function(){va||n.show();va=false});p.showOnTap&&n.tap(G,function(){n.show();databg();})}};n.trigger=function(a,c){return E(a,c)};n.option=function(a,c){var b={};"object"===typeof a?b=a:b[a]=
